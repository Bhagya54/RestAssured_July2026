package org.example.Day5_Jackson;
...
public class JaksonDemo {
    RequestSpecification req;
    Response res;
    ValidatableResponse vRes;
    ObjectMapper mapper = new ObjectMapper();
    @Test
    public void createBooking_TestNGAss() throws JsonProcessingException {
        ...
        String jsonStringPayload=mapper.writeValueAsString(createBooking);
        req=given();
